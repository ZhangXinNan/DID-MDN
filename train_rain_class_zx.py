...
import models.derain_residual as derain_residual
import models.derain_dense as derain_dense
...
def get_args():
  ...
  parser.add_argument('--dataset', required=False, default='pix2pix_class', help='')
  parser.add_argument('--dataroot', required=False, default='./facades/DID-MDN-training-zx', help='path to trn dataset')
  ...
  parser.add_argument('--originalSize', type=int, default=586, help='the height / width of the original input image')
  ...
  # parser.add_argument('--ndf', type=int, default=64/Rain_Medium/train2018new)
  ...
  parser.add_argument('--netG', default='./classification/netG_epoch_9.pth', help="path to netG (to continue training)")
  # parser.add_argument('--netD', default='', help="path to netD (to continue training)")
  parser.add_argument('--workers', type=int, help='number of data loading workers', default=1)
  parser.add_argument('--exp', default='./check_class', help='folder to output images and model checkpoints')
...
# './classification/netG_epoch_9.pth'
netG = derain_dense.vgg19ca()
...
residue_net = derain_residual.Dense_rain_residual()
...
for epoch in range(opt.niter):
  ...
  for i, data in enumerate(dataloader, 0):
    ...
    # z = 0
    label_cpu = torch.FloatTensor(opt.batchSize).fill_(0)
